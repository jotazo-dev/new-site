...
export default function ContaPedidoDetalhe() {
  ...
  if (!order) {
    return (
      <Card className="p-10 text-center text-muted-foreground">
        ...
        <Button className="mt-4" size="sm" onClick={() => navigate("/conta/pedidos")}>Voltar</Button>
      </Card>
    );
  }
  ...
  return (
    <>
      <Helmet><title>Pedido #{String(order.id).slice(0, 8).toUpperCase()} — Jotazo</title><meta name="robots" content="noindex,nofollow" /></Helmet>
      <div className="space-y-5">
        <Link to="/conta/pedidos" className="inline-flex items-center text-sm text-muted-foreground hover:text-foreground">
